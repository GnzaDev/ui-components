...
<SideSheet open={sheetOpen} onClose={() => setSheetOpen(false)} title="Checkout Drawer">
  ...
  },
  {
    ...
    physics: {
      engine: "Motion Micro-Springs",
      concept: "Micro-Spring Impact",
      details: "Initial subtle scale-down before springing up gives critical actions a grounded, tactile presence that commands attention.",
    },
    props: [
      { name: "open", type: "boolean", defaultVal: "false", description: "Dialog visibility state." },
